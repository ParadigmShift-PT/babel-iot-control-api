 ...
 * units). Each supported sensor family declares its own enumeration
 * inside this class, and concrete input requests carry one of these
 * values to tell the protocol which read mode to use.
 *
