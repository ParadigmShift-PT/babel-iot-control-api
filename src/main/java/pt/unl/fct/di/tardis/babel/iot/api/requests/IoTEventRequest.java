 ...
 * output requests defined alongside each protocol implementation)
 * extend this class to add timing semantics, threshold predicates,
 * or operation-specific payloads. The handle of the targeted device
 * is always required.
 *
